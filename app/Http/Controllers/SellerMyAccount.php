...
class SellerMyAccount extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('seller.sellerMyAccPage', ['users' => $users]);
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('seller.sellerMyAccEditPage', ['users' => $users]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('MyAccountSeller.index')->with('success', 'Account Credentials Updated');
    }
